...
method_names = {'OPnP', 'EPnP\_GN','RPnP','DLT', 'EPnPL', 'OPnPL','EOPnP','EOPnPL', 'DLS'};
% method_names = {'OPnPL'};
is_planar = 0;
method_list = model.setup_methods(method_names, num, length(nps), is_planar);
...
save('Johnny_points_small_number.mat');

Johnny_plot_points_small_number;