...
% method_names = {'RPnL','OPnP', 'DLT\_Planar', 'EPnPL\_Planar', 'OPnPL','EOPnP','EOPnPL','EOPnP*'};
method_names = {'EPnPL\_Planar', 'OPnPL','EOPnPL'}; %PnPL之间比较     
is_planar = 1;
...
save('c_planar_lines_pts_eq_constr_small_num.mat');

a_plot_planar_eq_constr_lines_pts_small_num;