function e_plot_planar_lines_small_num
load('e_planar_lines_small_num.mat');
...
yrange = [0 1.5];
[mnames, p] = xdraw_main(Xarg,yrange,method_list,'med_r','Median Rotation',XLabel,'Rotation Error (degree)', ws);
correct_margin();
...
xdraw_main(Xarg,yrange,method_list,'mean_r','Mean Rotation',...
    XLabel,'Rotation Error (degree)',ws);
correct_margin();
