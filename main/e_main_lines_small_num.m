...
% method_names = { 'Mirzaei','ASPnL','Ansar','RPnL', 'DLT', 'EPnPL', 'OPnPL', 'EOPnPL'};
method_names = {'EPnPL','OPnPL','EOPnPL','EOPnPL-BJ-0','EOPnPL-BJ-1'};
...
save('e_lines_small_number.mat');

e_plot_lines_small_number;