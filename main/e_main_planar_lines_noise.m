...
% method_names = { 'RPnL',  'DLT\_Planar', 'EPnPL\_Planar', 'OPnPL', 'EOPnPL','EOPnP*'}; 
method_names = { 'Mirzaei','ASPnL','RPnL',  'DLT\_Planar', 'EPnPL\_Planar', 'OPnPL', 'EOPnPL'}; % Ansar平面失败
% method_names = { 'EOPnPL', 'EPnPL\_Planar'};
...
%             if y(1) > 179
%                 p = p + 1;
%                eval(['save zzz_EOPnPL_planar_line_errorlarge' num2str(p)]) 
%             end
...
save('e_planar_lines_noise.mat');

e_plot_planar_lines_noise;