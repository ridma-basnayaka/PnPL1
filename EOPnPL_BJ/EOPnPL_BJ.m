function [R,t] = EOPnPL_BJ(Xw,Ximgn,xs,xe,Xs,Xe,iter1,iter2,PnP_iter)
    ...
    nl = size(Xs,2);
     if( all(abs(Xs(3,:) - repmat(Xe(3,1),1,nl)) < 1e-5) && ...
        ...
        [R,t] = Planar_EOPnPL(Xw,Ximgn,xs,xe,Xs,Xe);
         ...
         [R,t] = EOPnPL_BJ_ordinary_5(Xw,Ximgn,xs,xe,Xs,Xe,iter1,iter2,PnP_iter);
    ...
    np = size(Xw,2);
     if( all(abs(Xw(3,:) - repmat(Xw(3,1),1,np)) < 1e-5) ) 
        ...
        [R,t] = Planar_EOPnPL(Xw,Ximgn,xs,xe,Xs,Xe);
         ...
         [R,t] = EOPnPL_BJ_ordinary(Xw,Ximgn,xs,xe,Xs,Xe);
     end
