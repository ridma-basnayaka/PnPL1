function [s_all,R_result_all,t_all] = recover_all_at_once(r,W,V)
n = size(r,2);
R_all = zeros(3,3,n);
for i = 1 : n
...
% n = size(r,2);
% R_estimate_all = reshape(r,3,3*n)'; % 3n*3矩阵，每三行对应一个旋转矩阵
% 
% R_all = zeros(3,3,n);
% for i = 1 : n
%     [Ur,~,Vr] = svd( R_estimate_all(3*i-2:3*i,:) );
%     R_all(:,:,i) = Ur*Vr';
% end
